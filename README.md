...
- [PDF denoising and cleaning in Colab](#pdf-denoising-and-cleaning-in-colab)
  ...
  - [How the Pipeline Works](#how-the-pipeline-works)
    - [Batch PDF Detection](#batch-pdf-detection)
    - [Per-File Processing Loop](#per-file-processing-loop)
    - [Metadata Extraction + OCR Fallback](#metadata-extraction--ocr-fallback)
    - [Chunking & Hashing](#chunking--hashing)
    - [Embeddings + ChromaDB Insert](#embeddings--chromadb-insert)
    - [Storing Processed PDFs in Google Drive](#storing-processed-pdfs-in-google-drive)
